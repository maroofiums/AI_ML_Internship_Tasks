...
# General Health Query Chatbot (Task 4 – Internship Project)
...
This project implements a **General Health Query Chatbot** using **Large Language Models (LLMs)**. It is designed to answer general health-related questions in a friendly and safe manner. The project was completed as **Task 4** during my internship, focusing on **prompt engineering, API integration, and user-friendly chat interface design**.

The chatbot **does not provide medical diagnosis or prescriptions** and is intended solely for educational and informational purposes.
...
* **Prompt Engineering:** System prompt ensures the chatbot maintains a professional and safe tone.
...
* **Deployment Ready:** Works on Streamlit with Hugging Face LLM backend.
...
1. **Prompt & Safety Function**
   ...
   * System prompt crafted to instruct the model to act as a friendly medical assistant.
   * Safety function prevents responses for unsafe queries.

2. **LLM Integration**

   * Hugging Face `InferenceClient` used to interact with Mistral-7B-Instruct.
   * Streaming API used to display real-time responses in the chat.
...
* Successfully implemented a **safe, interactive health chatbot**.
